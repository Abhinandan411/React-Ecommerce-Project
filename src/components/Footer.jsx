...
function Footer() {
    return (
        <>
            <footer className="bg-gradient-to-r from-gray-100 via-[#bce1ff] to-gray-100 mt-[6rem] shadow-lg shadow-indigo-500/40">
                <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                        <div>
                            <img src="https://e7.pngegg.com/pngimages/541/564/png-clipart-almelo-stadskanaal-apeldoorn-house-building-color-simple-furniture-home-logo-color-splash-furniture-thumbnail.png" className="mr-5 h-6 sm:h-9 w-1/8" alt="logo" />
                    ...
                    <p className="mt-8 text-xs text-gray-800">
                        © copy right Abhinandan || all rights reserved
                    </p>
                </div>
            </footer>
        </>
